    ...
    try:
        ...
        c.execute('''INSERT INTO patients 
                    ...
                    (data.get('nom'), data.get('adresse'), data.get('dateNaissance'), data.get('age'),
                     ...
                     data.get('commentaireDerniereUtilisation')))
...
def afficher_patient(patient_id):
    ...
    if patient:
        patient_info = {
            ...
            'saignement': patient[17],
'vomissement': patient[18],
'fievre': patient[19],
'tabac': patient[20],
'alcool': patient[21],
'radiation': patient[22],
'no': patient[23],
'annee': patient[24],
'sexe': patient[25],
'age_gest': patient[26],
...
'lieu_acc': patient[28],
'type_acc': patient[29],
'radiation_obstetrique': patient[30],
'remarques': patient[31],
'problemes_sante': patient[32],
'on': patient[33],
'remarques_medicales': patient[34],
'maladies_renales': patient[35],
'problemes_cardiaques': patient[36],
'hypertension_arterielle': patient[37],
'diabete': patient[38],
'infection': patient[39],
'maladie_thyroide': patient[40],
'transfusion': patient[41],
'chirurgie': patient[42],
'herpes': patient[43]
        }
