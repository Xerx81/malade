...
def afficher_patient(patient_id):
    ...
    if patient:
        patient_info = {
            ...
            'lieu_acc': patient[41],
            'type_acc': patient[42],
            'radiation_obstetrique': patient[43],
            'remarques': patient[44],
            'problemes_sante': patient[45],
            'on': patient[46],
            'remarques_medicales': patient[47],
            'maladies_renales': patient[48],
            'problemes_cardiaques': patient[49],
            'hypertension_arterielle': patient[50],
            'diabete': patient[51],
            'infection': patient[52],
            'maladie_thyroide': patient[53],
            'transfusion': patient[54],
            'chirurgie': patient[55],
            'herpes': patient[56]
        }
