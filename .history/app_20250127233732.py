...
def init_db():
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS patients (
                 ...
                 remarques_hypertension_med TEXT,
                 diabete TEXT,
                 ...
                 antecedent_hypertension TEXT,
                 remarques_hypertension TEXT,
                 antecedent_diabete TEXT,
                 remarques_diabete TEXT,
                 antecedent_maladie_cardiaque TEXT,
                 remarques_maladie_cardiaque TEXT,
                 antecedent_gemellaire TEXT,
                 remarques_gemellaire TEXT,
                 antecedent_malformation TEXT,
                 remarques_malformation TEXT,
                 antecedent_maladie_genetique TEXT,
                 remarques_maladie_genetique TEXT,
...
def save_patient():
    try:
        ...
        values = [data.get('nom'), data.get('adresse'), data.get('dateNaissance'), data.get('age'),
                 ...
                 data.get('hypertension_arterielle'), data.get('remarques_hypertension_med'),
                 ...
                 data.get('antecedent_hypertension'), data.get('remarques_hypertension'),
                 data.get('antecedent_diabete'), data.get('remarques_diabete'),
                 data.get('antecedent_maladie_cardiaque'), data.get('remarques_maladie_cardiaque'),
                 data.get('antecedent_gemellaire'), data.get('remarques_gemellaire'),
                 data.get('antecedent_malformation'), data.get('remarques_malformation'),
                 data.get('antecedent_maladie_genetique'), data.get('remarques_maladie_genetique')]
        ...
        insert_sql = '''INSERT INTO patients 
                    (nom, adresse, date_naissance, age, statut, occupation, numero_personnel, numero_etablissement,
                     ...
                     hypertension_arterielle, remarques_hypertension_med, diabete, remarques_diabete,
                     ...
                     herpes, remarques_herpes, antecedent_hypertension, remarques_hypertension,
                     antecedent_diabete, remarques_diabete, antecedent_maladie_cardiaque, remarques_maladie_cardiaque,
                     antecedent_gemellaire, remarques_gemellaire, antecedent_malformation, remarques_malformation,
                     antecedent_maladie_genetique, remarques_maladie_genetique)'''
